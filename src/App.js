...
function App() {
  ...
  const handleSearch = async e => {
    ...
    const endpoint = `https://en.wikipedia.org/w/api.php?action=query&
  ...
  return (
    ...
    <div className="App">
      <header>
          ...
          <h1><i class="fa fa-wikipedia-w"  /></h1>
        ...
        {results.map((result, i) => {
          ...
          return (
            <div className="result" key={i}>
              ...
              <a href={url} target="_blank" rel="noreferrer"><i class="fa fa-wikipedia-w"></i></a>
              </div>
          )
        })}
